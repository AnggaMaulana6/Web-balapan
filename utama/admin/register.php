...
if (isset($_POST['registrasi'])) {
    ...
    $sql = mysqli_query($con, "INSERT INTO user (nama, alamat, no_hp, password, level, status)
                        VALUES ('$nama', '$alamat', '$telp', '$password', 'admin', 'aktif');");
    if ($sql) {
                    ...
                    <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                        <div class="w-full">
                            ...
                            <label class="block text-sm">
                                ...
                                <textarea name="alamat" class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Alamat Anda" required></textarea>
                            </label>
                            <label class="block text-sm">
