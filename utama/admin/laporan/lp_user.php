...
$query = mysqli_query($con, "SELECT * FROM user LEFT JOIN event ON user.id_event = event.id_event WHERE user.level = 'user';");
$getData = mysqli_fetch_all($query, MYSQLI_ASSOC);

if(isset($_GET['aktif'])){
$query = mysqli_query($con, "SELECT * FROM user LEFT JOIN event ON user.id_event = event.id_event WHERE user.level = 'user' AND status='aktif';");
$getData = mysqli_fetch_all($query, MYSQLI_ASSOC);
}

if(isset($_GET['proses'])){
$query = mysqli_query($con, "SELECT * FROM user LEFT JOIN event ON user.id_event = event.id_event WHERE user.level = 'user' AND status='proses';");
$getData = mysqli_fetch_all($query, MYSQLI_ASSOC);
}
