...
if (isset($_POST['registrasi'])) {
    $kelas = $_POST['kelas_name'];

    $query = mysqli_query($con, "INSERT INTO kelas (kelas_name)
                            VALUES ('$kelas') ");
    if ($query) {
        echo '<script>
                    ...
                    <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                        <div class="w-full">
                            ...
                            <label class="block text-sm">
                                ...
                                <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Nama Kelas" type="text" name="kelas_name" required />
                            </label>
                            ...
                            <p class="mt-4">
                                <a class="text-sm font-medium text-purple-600 dark:text-purple-400 hover:underline" href="./kelas.php">
                                    Kembali
                                </a>
                            </p>
                        </div>
