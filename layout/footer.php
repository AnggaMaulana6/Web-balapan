        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="footer-col first">
                    <h6>About Lamban</h6>
                    <p class="p-small">modifikasi 4x4 atau 4wd, produk, event, bengkel, tips & trik</p>
                </div> <!-- end of footer-col -->
                <div class="footer-col second">
                    <h6>Address</h6>
					<p class="p-small">Jl. Panembahan, Jetis, Tamantirto, Kec. Kasihan, Kabupaten Bantul, Daerah Istimewa Yogyakarta 55184</p>
                ...
                <div class="footer-col third">
                    ...
                    <p class="p-small">We would love to hear from you <a href="mailto:lambangarage@gmail.com"><strong>lambangarage@gmail.com</strong></a></p>
                </div> <!-- end of footer-col -->
            </div> <!-- end of col -->
        </div> <!-- end of row -->
